...
def detect(img_dir, output_dir, model, visualizer=None):
    ...
    for img_file in tqdm(os.listdir(img_dir)):
        ...
        # if visualizer:
        #     os.makedirs('../datasets/coco/poison/vis_img_oda_coco_mmdet/', exist_ok=True)
        ...
        #         draw_gt=False,
        #         wait_time=0,
        #         out_file = '../datasets/coco/poison/vis_img_oda_coco_mmdet/' + img_file,
        #     )
...
def asr():
    ...
    output_path = '../datasets/coco/poison/test_poison_img_oda_coco_mmdet/'
    TP_ANNOTATION_PATHS = '../datasets/coco/poison/tp_annotations_oda_coco_mmdet/'
