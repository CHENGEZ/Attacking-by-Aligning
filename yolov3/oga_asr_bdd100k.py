...
def asr(model_path):
    ...
    output_path = '../datasets/coco/poison/test_poison_img_oga_bdd100k_yolov3/'
    PRED_ANNOTATION_PATHS = '../datasets/coco/poison/pred_annotations_oga_bdd100k_yolov3/'

    os.makedirs(output_path, exist_ok=True)
    os.makedirs(PRED_ANNOTATION_PATHS, exist_ok=True)
    rm_under_dir(output_path)
    rm_under_dir(PRED_ANNOTATION_PATHS)
